<?php
/**
 * Inits squiremail session so after he clicks login link from page he gets to mail window, and no need to login again. This
 * Is done by sendiing javascript requirest with username and password to this page via json.
 * */

...
if (sqgetGlobalVar('passed_id', $passed_id)) {
...
//http://77.79.12.75/webmail/src/read_body.php?mailbox=INBOX&passed_id=6137&startMessage=1
...
switch($right_frame_file) {
    ...
    case 'compose.php':
        ...
        break;        
    case 'read_body.php':
        $right_frame_url = 'read_body.php?mailbox='.urlencode($mailbox)
                           . '&amp;passed_id='.$passed_id
                           . (!empty($startMessage)?"&amp;startMessage=$startMessage":'');
        break;
    case '':
...
if ($location_of_bar == 'right') {
    $output .= "<frame src=\"../../src/$right_frame_url\" name=\"right\" frameborder=\"1\" />\n" .
               "<frame src=\"../../src/left_main.php\" name=\"left\" frameborder=\"1\" />\n";
}
else {
    $output .= "<frame src=\"../../src/left_main.php\" name=\"left\" frameborder=\"1\" />\n".
               "<frame src=\"../../src/$right_frame_url\" name=\"right\" frameborder=\"1\" />\n";
}
